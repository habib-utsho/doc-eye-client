...
const ConsultationHistoryDetailsPage = ({ from }: { from: TUserRole }) => {
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 md:col-span-8 space-y-4">
          ...
          <div className="shadow p-4 rounded-md flex gap-4 justify-between items-center flex-wrap">
            ...
            <div className="flex items-center  w-[200px] rounded-md shadow shadow-primary">
              <Chat
                from={from}
...
export default ConsultationHistoryDetailsPage;
